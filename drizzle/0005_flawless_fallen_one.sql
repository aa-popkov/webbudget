...
INSERT INTO `__new_budget_table`("id", "userId", "amount", "categoryId", "date", "type") SELECT "id", "userId", "amount", "categoryId", "date", "type" FROM `budget_table`;--> statement-breakpoint
